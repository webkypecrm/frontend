...
const TaskCategory = () => {
    ...
    // console.log('taskCategoryDetails =>', taskCategoryDetails, num1++)
    ...
    const handleAdd = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/master/add-task-category`, {
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                throw new Error(resData.message || 'Failed to add task category');
            }
    ...
    const handleEdit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/master/edit-task-category`, {
                method: 'PUT',
                headers: {
                    Authorization: `Bearer ${Token}`
                },
            ...
            setFormData(initialForm)
            fetchData()
            toast.success('Task category edited successfully!');
    ...
    const handleDelete = async (event) => {
        event.preventDefault();
        try {
            const response = await fetch(`${apiUrl}/master/delete-task-category/${taskCategoryDetails.id}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${Token}`
                }
        ...
        <div>
                ...
                <div className="content">
                    <div className="row">
                        <div className="col-md-12">
                            {/* Page Header */}
                            <PageHeader title="Task Category" />
                            {/* /Page Header */}
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Add New Task Category</h5>
                            <button
                                className="btn-close"
                            ...
                            <form onSubmit={handleAdd}>
                                ...
                                <div className="form-wrap">
                                    <label className="col-form-label">
                                        Task Category Name <span className="text-danger">*</span>
                                    </label>
                                    <input
                                        type="text"
                                        className="form-control"
                                ...
                                <p style={{ fontSize: 'small', color: '#7695FF' }}>Note: You can add multiple departments at once by separating them with commas (,)</p>
            ...
            <div className="modal custom-modal fade" id="edit_source" role="dialog">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Edit Task Category</h5>
                            <button
                                className="btn-close"
                                data-bs-dismiss="modal"
                                aria-label="Close"
