...
const Group = () => {
    ...
    const handleAdd = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/master/add-group`, {
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                throw new Error(resData.message || 'Failed to add group');
            }
    ...
    const handleEdit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/master/edit-group`, {
                method: 'PUT',
                headers: {
                    Authorization: `Bearer ${Token}`
                },
            ...
            const resData = await response.json();
            if (!response.ok) {
                throw new Error(resData.message || 'Failed to edit group');
            }
    ...
    const handleDelete = async (event) => {
        event.preventDefault();
        try {
            const response = await fetch(`${apiUrl}/master/delete-group/${groupDetails.id}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${Token}`
                }
            ...
            const resData = await response.json();
            if (!response.ok) {
                throw new Error(resData.message || 'Failed to delete group');
            }
            setGroupDetails({})
            fetchData()
                            ...
                            <form onSubmit={handleAdd}>
                                ...
                                <div className="form-wrap">
                                    ...
                                    <input
                                        type="text"
                                        className="form-control"
                                        placeholder="Eg: Group X,Group Y"
                                        name='name'
                                        value={formData.name}
                                        required
                                ...
                                <p style={{ fontSize: 'small', color: '#7695FF' }}>Note: You can add multiple groups at once by separating them with commas (,)</p>
