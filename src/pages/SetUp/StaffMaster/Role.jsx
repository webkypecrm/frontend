...
const Role = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${apiUrl}/master/role-list`);
    ...
    const handleAdd = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/master/add-role`, {
                method: 'POST',
                headers: {
    ...
    const handleEdit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/master/edit-role`, {
                method: 'PUT',
                headers: {
                    Authorization: `Bearer ${Token}`
                },
            ...
            const resData = await response.json();
            if (!response.ok) {
                throw new Error(resData.message || 'Failed to edit department');
            }
    ...
    const handleDelete = async (event) => {
        event.preventDefault();
        try {
            const response = await fetch(`${apiUrl}/master/delete-role/${roleDetails.id}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${Token}`
                }
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Add New Roles</h5>
                            <button
                                className="btn-close"
                            ...
                            <form onSubmit={handleAdd}>
                                <div className="form-wrap">
                                    ...
                                    <Select
                                        ...
                                        className="select"
                                        value={departmentOptions.find((ele) => formData.departmentId === ele.value)}
                                        onChange={(event) => {
                                            let { value } = event
                                ...
                                <div className="form-wrap">
                                    ...
                                    <input
                                        ...
                                        className="form-control"
                                        name='name'
                                        placeholder="Eg: Sales Support,Sales Consultant"
                                        value={formData.name}
                                        required
