...
const Industry = () => {
      ...
      render: () => (
        <div className="dropdown table-action">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            <Link className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#edit_industry">
              <i className="ti ti-edit text-blue" /> Edit
            </Link>
            <Link className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#delete_industry">
  ...
  return (
    <div>
                ...
                <div className="row align-items-center">
                  <div className="col-sm-8">
                    <h4 className="page-title">
                      Industry <span className="count-title">123</span>
                    </h4>
                  </div>
      ...
      {/* /Page Wrapper */}
      {/* Add New Industry */}
      <div className="modal custom-modal fade" id="add_industry" role="dialog">
      ...
      {/* /Add New Industry */}
      {/* Edit Industry */}
      <div className="modal custom-modal fade" id="edit_industry" role="dialog">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
