...
const TaskDetailsPage = () => {
    ...
    const fetchTaskLogData = async () => {
        try {
            const response = await axios.get(`${apiUrl}/task/task-log/${data?.taskId}`, {
                headers: {
            ...
            const commentUpdate = response.data.data.filter((item) => item.type == 'taskComment')
    ...
    const fetchTaskDetails = async () => {
        try {
            const response = await axios.get(`${apiUrl}/task/task-details/${taskId}`,
                {
                    headers: {
                        Authorization: `Bearer ${Token}`
                    }
    ...
    return (
        <>
                                ...
                                <div className="contact-profile">
                                    <div className="avatar company-avatar">
                                        <span className="text-icon">
                                            {data?.taskTitle[0]}{data?.taskTitle[data?.taskTitle?.length - 1]}
                                        </span>
                                    </div>
                                ...
                                {taskLogData.length > 0 &&
                                    <ul className="other-info">
                                        <li>
                                            ...
                                            <span>{taskLogData[0]?.createdAtDate}, {taskLogData[0]?.createdAtTime}</span>
                                        </li>
                                        <li>
                                            <span className="other-title">Modified By</span>
                                            <span>
                                                <img
                                                    src={taskLogData[0]?.staff?.profilePicUrl}
                                                    className="avatar-xs"
                                                    alt="img"
                                                />{" "}
                                                {taskLogData[0]?.staff?.name}
                                            </span>
                                        </li>
                                    </ul>
                                }
                        ...
                        <div className="col-xl-9">
                            <div className="contact-tab-wrap">
                                <ul className="contact-nav nav">
                                    ...
                                    <li>
                                        <Link to="#" data-bs-toggle="tab" data-bs-target="#task-meeting">
                                            <i className="ti ti-notes" />
                                            Meeting
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="#" data-bs-toggle="tab" data-bs-target="#task-comment">
                                ...
                                <div className="tab-content pt-0">
                                        ...
                                        <div className="contact-activity">
                                            ...
                                            {Object.keys(groupActivityByDate).map((date) =>
                                                <div key={date}>
                                                    ...
                                                    <ul>
                                                        {groupActivityByDate[`${date}`].map((lead) => <li className={lead.type == 'fileUpdate' || lead.type == 'meetingUpdate' || lead.type == 'callUpdate' ? "" : "activity-wrap"} key={lead.taskLogId} style={{ marginBottom: '1rem' }}>
                                                                        ...
                                                                        <div className="caller-info">
                                                                            <div className="calls-user">
                                                                                ...
                                                                                <div style={{ display: 'grid' }}>
                                                                                    {callData[0]?.taskLogId !== lead?.taskLogId && lead?.status !== 'Done' ?
                                                                                        <p>
                                                                        ...
                                                                        <div className="calls-box" >
                                                                            <div className="caller-info">
                                                                                <div className="calls-user">
                                                                                    ...
                                                                                    />
                                                                                    <div style={{ display: 'grid' }}>
                                                                                        {meetingData[0]?.taskLogId !== lead?.taskLogId && lead?.status !== 'Done' ?
                                                                            ...
                                                                            <div className="row align-items-center">
                                                                                        ...
                                                                                        <div className="file-user" >
                                                                                            ...
                                                                                            <div style={{ display: 'grid' }}>
                                                                                                ...
                                                                                                <p style={{ fontSize: 'x-small', margin: '0', maxWidth: '8rem' }}>
                                                                                                    {getDate(lead?.taskDocument?.createdAt)},{getTime(lead?.taskDocument?.createdAt)}
                                                                                                </p>
                                                                                            </div>
                                                                                        </div>
                                                                                        <h4>{lead?.taskDocument?.fileName}</h4>
                                                                                        <p>
                                                                                ...
                                                                                <div className="col-md-4 text-md-end">
                                                                                    <ul className="file-action">
                                                                                        ...
                                                                                        <li>
                                                                                            <Link className="badge badge-tag badge-danger-light" to={lead?.taskDocument?.attachmentUrl}>
                                                                                                <span>{lead?.taskDocument?.fileType}</span>
                                                                                                <Link className="badge badge-tag badge-danger-light" to={lead?.taskDocument?.attachmentUrl}>
                                                                                                    {/* <span>{lead?.taskDocument?.fileType}</span> */}

                                                                                                    {lead?.taskDocument?.fileType == 'image' &&
                                                                                                        <div className="note-download">
                                                                                                            <div className="note-info">
                                                                                                                <span className="note-icon">
                                                                                                                    <img src={lead?.taskDocument?.attachmentUrl} alt="Preview" style={{ width: '300px', height: 'auto' }} />
                                                                                                                </span>
                                                                                                            </div>

                                                                                                        </div>
                                                                                                    }
                                                                                                    {lead?.taskDocument?.fileType == 'jpg' &&
                                                                                                        <div className="note-download">
                                                                                                            <div className="note-info">
                                                                                                                <span className="note-icon">
                                                                                                                    <img src={lead?.taskDocument?.attachmentUrl} alt="Preview" style={{ width: '300px', height: 'auto' }} />
                                                                                                    ...
                                                                                                    {lead?.taskDocument?.fileType == 'png' &&
                                                                                                        <div className="note-download">
                                                                                                            <div className="note-info">
                                                                                                                <span className="note-icon">
                                                                                                                    <img src={lead?.taskDocument?.attachmentUrl} alt="Preview" style={{ width: '300px', height: 'auto' }} />
                                                                                                    ...
                                                                                                    {lead?.taskDocument?.fileType == 'pdf' &&
                                                                                                        <div className="note-download">
                                                                                                            <div className="note-info">
                                                                                                                <span className="note-icon">
                                                                                                    ...
                                                                                                    {lead?.taskDocument?.fileType === 'zip' && (
                                                                                                        <div className="note-download">
                                                                                                            <div className="note-info">
                                                                                                                <span className="note-icon">
                                                                                                    ...
                                                                                                    {lead?.taskDocument?.fileType === 'csv' && (
                                                                                                        <div className="note-download">
                                                                                                            <div className="note-info">
                                                                                                                <span className="note-icon">
                                    ...
                                    <div className="tab-pane fade" id="task-meeting">
                                        ...
                                        <div className="notes-activity" >
                                            ...
                                            {meetingData.map((data, index) => <div className="calls-box" key={data?.taskLogId}>
                                                <div className="caller-info">
                                                    <div className="calls-user">
                                                        <img
                                    ...
                                    <div className="tab-pane fade" id="task-calls">
                                        ...
                                        <div className="calls-activity" >
                                            ...
                                            {callData.map((data, index) => <div className="calls-box" key={data.taskLogId}>
                                                <div className="caller-info">
                                                    <div className="calls-user">
                                                        <img
                                                            src={data?.staff?.profilePicUrl}
                                    ...
                                    <div className="tab-pane fade" id="task-files">
                                        ...
                                        <div className="files-activity">
                                            ...
                                            {fileData.map((file) => <div className="files-wrap" key={file.taskLogId}>
                                                <div className="row align-items-center">
                                                    <div className="col-md-8">
                                                        <div className="file-info">
                                                            <div className="file-user" >
                                                                ...
                                                                <div style={{ display: 'grid' }}>
                                                                    ...
                                                                    <p style={{ fontSize: 'x-small', margin: '0', maxWidth: '8rem' }}>{getDate(file?.taskDocument?.createdAt)},{getTime(file?.taskDocument?.createdAt)}</p>
                                                                </div>

                                                            </div>
                                                            <h4>{file?.taskDocument?.fileName}</h4>
                                                            <p>
                                                                {file?.taskDocument?.comment}
                                                            </p>
                                                            <p>
                                                                {/* {file?.taskDocument?.createdAt} */}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-4 text-md-end">
                                                        <ul className="file-action">
                                                            <li>
                                                                <Link className="badge badge-tag badge-danger-light" to={file?.taskDocument?.fileType === 'video' ? file?.taskDocument?.link : file?.taskDocument?.attachmentUrl}>

                                                                    <span>{file?.taskDocument?.fileType}</span>
                                                                    {file?.taskDocument?.fileType == 'image' &&
                                                                        <div className="note-download">
                                                                            <div className="note-info">
                                                                                <span className="note-icon">
                                                                                    <img src={file?.taskDocument?.attachmentUrl} alt="Preview" style={{ width: '300px', height: 'auto' }} />
                                                                                </span>
                                                                            </div>
            ...
            <AddCallComment fetchTaskLogData={fetchTaskLogData} taskLogId={taskLogId} />

            <RescheduleCall fetchTaskLogData={fetchTaskLogData} taskDetails={data} />

            <RescheduleMeeting fetchTaskLogData={fetchTaskLogData} taskDetails={data} />

            <AddMeetingComment fetchTaskLogData={fetchTaskLogData} taskLogId={taskLogId} />
            ...
            <AddTaskDocuments fetchLeadFollowupData={fetchTaskLogData} taskDetails={data} />
