...
const RescheduleMeeting = ({ fetchLeadFollowupData, leadDetails}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/lead/update-meeting-rescheduled`, {
                method: 'POST',
                headers: {
