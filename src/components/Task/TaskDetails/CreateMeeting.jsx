...
const CreateMeeting = ({ fetchTaskDetails, taskDetails}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/task/meeting-update`, {
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                throw new Error(resData.message || 'Failed to update meeting');
            }
